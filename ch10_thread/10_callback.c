...
int main(void) {
  const char *urls[] = {
      "https://berylyvos.icu/file1",
      "https://berylyvos.icu/file2",
      "https://berylyvos.icu/file3",
      "https://berylyvos.icu/file4",
      "https://berylyvos.icu/file5",
  };
  ...
  for (int i = 0; i < DOWNLOAD_TASKS; ++i) {
    requests[i] = (DownloadRequest) {
        ...
        .progress = 0,
        .interval = (DOWNLOAD_TASKS - i) * 15 + 5,
